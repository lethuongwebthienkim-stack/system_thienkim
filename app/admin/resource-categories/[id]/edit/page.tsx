  ...
  if (categoryData === null) {
    return (
      <div className="py-12 text-center">
        ...
        <Link href="/admin/resource-categories" className="mt-2 inline-block text-indigo-600 hover:underline">Quay lại danh sách</Link>
      </div>
    );
  }
    ...
    <div className="mx-auto max-w-4xl space-y-6 pb-20">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Sửa danh mục tài nguyên</h1>
